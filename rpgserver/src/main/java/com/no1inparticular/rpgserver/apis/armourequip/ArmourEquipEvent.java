...
public final class ArmourEquipEvent extends PlayerEvent implements Cancellable{
	 ...
	 */
	public ArmourEquipEvent(final Player player, final EquipMethod equipType, final ArmourType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
